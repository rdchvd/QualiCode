...
from wed29.csv_utils import get_english_dictionary
...
def process_chunks(index, words_list, batch_size=1000):
    ...
    for words_chunk in chunked(words_list, batch_size):
        ...
        try:
            index.upsert(vectors=vectors_with_data)
...
def main():
    ...
    words_list = get_english_dictionary()
    # print(f"{words_list=}")
    # todo: finish this
